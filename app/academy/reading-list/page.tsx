...
import { getPublishedReadingItems } from "@/lib/supabase/queries/reading-list";
...
export default async function ReadingListPage() {
  ...
  const items = await getPublishedReadingItems();
  ...
  return (
    <div className="min-h-screen pb-24 bg-white">
      ...
      <div className="container mx-auto px-4 max-w-6xl mt-16 md:mt-24">
        <ReadingList dictionary={dictionary} items={items} locale={locale} />
      </div>
    </div>
  );
}
