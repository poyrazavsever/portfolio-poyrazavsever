  ...
  return (
    <div className="group flex flex-col sm:flex-row sm:items-center justify-between p-5 bg-white border-b border-dashed border-slate-200 hover:bg-slate-50 transition-colors">
      <div className="flex gap-4">
        ...
        <div>
          <h3 className="font-bold text-lg text-slate-900 group-hover:text-red-600 transition-colors mb-1">
            {title}
          </h3>
      ...
      <div className="mt-4 sm:mt-0 pl-10 sm:pl-0">
        <Button
          variant="ghost"
          size="sm"
          className="gap-2 text-slate-400 group-hover:text-red-600 hover:bg-white"
          asChild
        >
